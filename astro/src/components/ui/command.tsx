  ...
  return (
    <div data-slot="command-input-wrapper" className="flex h-9 items-center gap-2 border-b px-3">
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          'flex h-10 w-full rounded-md bg-transparent placeholder:text-muted-foreground',
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        ...
        '[&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-xs',
        className,
      )}
      {...props}
    />
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        'select-none rounded-xs px-2 py-1.5 text-sm outline-hidden data-[disabled=true]:pointer-events-none',
